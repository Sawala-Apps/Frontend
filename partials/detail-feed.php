...
<div class="w-[80%] max-lg:w-[100%] mx-auto mb-6 p-6 bg-[#DFE5F2] border-brutal shadow-brutal rounded-lg">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            <img src="<?= $post['pfp_url']; ?>" alt="User Avatar" class="w-10 h-10 rounded-md border-brutal shadow-brutal">
            <div>
    ...
    <div class="mt-4 flex flex-col items-center">
        <img src="<?= $post['image_url']; ?>" alt="Post Image" class="w-[90vh] border-brutal rounded-lg">
        <div class="mt-6 flex flex-row w-[100%]">
...
<div class="w-[80%] max-lg:w-[100%] mx-auto mb-6 p-6 bg-[#E3E8F2] border-brutal shadow-brutal rounded-lg">
    ...
    <div class="comment flex items-start space-x-4 mb-4 bg-[#E3E0F3] rounded-lg p-3 border-brutal shadow-brutal">
        <img src="https://i.pinimg.com/736x/0b/57/0f/0b570f054699c8e7c6dbc9a821aa5be3.jpg" alt="User Avatar" class="w-10 h-10 rounded-md border-brutal shadow-brutal">
        <div class="comment-content flex-1">
            <div class="flex flex-row items-center ">
            <h5 class="font-bold">Hani</h5>
            </div>
            <p class="text-gray-800">Luchu banget ngabs<p>
        </div>
    </div>
    <div class="comment flex items-start space-x-4 mb-4 bg-[#E3E0F3] rounded-lg p-3 border-brutal shadow-brutal">
        <img src="https://i.pinimg.com/736x/47/ef/9d/47ef9d34bdc6a50d1d1de747c2cb8f04.jpg" alt="User Avatar" class="w-10 h-10 rounded-md border-brutal shadow-brutal">
        <div class="comment-content flex-1">
            <div class="flex flex-row items-center ">
            <h5 class="font-bold">Seyong</h5>
            </div>
            <p class="text-gray-800">mang iyh ngabs?<p>
        </div>
    </div>
    <div class="comment flex items-start space-x-4 mb-4 bg-[#E3E0F3] rounded-lg p-3 border-brutal shadow-brutal">
        <img src="https://i.pinimg.com/474x/26/ce/2e/26ce2ec538bc021a0eb96d6868dbca31.jpg" alt="User Avatar" class="w-10 h-10 rounded-md border-brutal shadow-brutal">
        <div class="comment-content flex-1">
            <div class="flex flex-row items-center ">
            <h5 class="font-bold">alomani</h5>
            </div>
            <p class="text-gray-800">xixixixix <p>
        </div>
    </div>
</div>
