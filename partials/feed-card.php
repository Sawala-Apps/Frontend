...
<div class="w-[70vh] mx-auto mt-10 p-6 bg-[#FD9745] border-brutal shadow-brutal rounded-lg mb-10">
    ...
    <div class="flex flex-row items-center justify-between mt-6">
        ...
        <button class="flex items-center space-x-2 px-4 py-2 bg-stone-100 text-black font-bold rounded-lg shadow-brutal hover:bg-green-600">
        ...
        <button class="flex items-center space-x-2 px-4 py-2 bg-stone-100 text-black font-bold rounded-lg shadow-brutal hover:bg-yellow-600">
