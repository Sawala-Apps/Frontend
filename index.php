...
<body class="bg-[#FFF3E0] text-[#1A1A1A] font-sans">
  ...
  <section id="features" class="py-12 px-6">
    <div class="text-center mb-12">
      <h2 class="text-4xl font-bold text-gray-900 mb-4">Fitur Utama Sawara untuk Mempermudah Diskusi dan Kolaborasi</h2>
      <p class="text-lg text-gray-700">Sawara dirancang untuk memfasilitasi diskusi yang lebih mudah dan interaktif antar pengguna, menyediakan berbagai alat untuk berbagi informasi, berbicara, dan membangun komunitas yang lebih dekat.</p>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="bg-[#FFE8A3] shadow-join border-brutal rounded-xl p-6 flex flex-col items-center">
        ...
        <p class="text-gray-700 text-center">Fitur chatbot untuk memberikan bantuan seputar pertanyaan umum dan navigasi di platform Sawara.</p>
      </div>
    </div>
  </section>
</body>
